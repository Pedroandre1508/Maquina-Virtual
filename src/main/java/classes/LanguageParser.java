...
public class LanguageParser implements LanguageParserConstants {
    ...
    public static String analisarESexecutar(String input, List<String> semanticErrors) throws ParseException, SemanticException {
      ...
      LanguageParser parser = create(input);
      parser.programa(); // Certifique-se de que o programa seja analisado antes de executar as instruções
      Controller controller = new Controller(); // Assuming Controller has a default constructor
      return parser.executarInstrucoes(controller);
  }

  public String executarInstrucoes(Controller controller) {
    AMaquinaVirtual maquinaVirtual = new AMaquinaVirtual(tabelaInstrucoes, tabelaSimbolos, controller);
